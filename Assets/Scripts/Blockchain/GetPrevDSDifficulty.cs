 ...
 */
public class GetPrevDSDifficulty : MonoBehaviour
{
    ...
    [Serializable]
    struct GetPrevDSDifficultyRequest
    {
        public int id;
    ...
    void Start()
    {
        try
        {
            GetPrevDSDifficultyRequest getPrevDSDifficulty = new GetPrevDSDifficultyRequest
            {
                id = 1,
                jsonrpc = "2.0",
                method = METHOD,
