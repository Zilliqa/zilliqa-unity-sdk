...
public class WithdrawLockedFundsFromAuction : ZilliqaMonoBehaviour
{
    ...
    [SerializeField] private int bidPrice = 10000;
    ...
    [SerializeField] private int getTransactionStatusMaxAttempts = -1;
