...
namespace Scrypt
{
    ...
    public class ScryptEncoder
    {
        ...
        public string Encode(string password, byte[] saltBytes, int iterationCount, int blockSize, int threadCount, int DKLength)
        {
            if (string.IsNullOrEmpty(password))
            {
                throw new ArgumentNullException("password");
            ...
            return EncodeV3(password, saltBytes, iterationCount, blockSize, threadCount, DKLength);
        }
        ...
        /// <summary>
        /// Hash a password using the scrypt scheme. with variable DK length
        /// </summary>
        private static string EncodeV3(string password, byte[] saltBytes, int iterationCount, int blockSize, int threadCount, int DKLength)
        {
            var N = iterationCount;
            var r = blockSize;
            var p = threadCount;
            ...
            var hashed = CryptoScrypt(passwordBytes, saltBytes, N, r, p, DKLength);
