...
namespace Zilliqa.Core
{
    public class ZilliqaRPC
    {
       ...
       where T : ZilResponse
        ...
        /// <summary>
        /// Once the auction has expired, the auction is considered as complete. 
        /// The seller can end the auction by calling the End transition.  
        /// This triggers the contract
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="tokenId"></param>
        /// <param name="bidPrice"></param>
        ...
        /// <param name="onComplete"></param>
        /// <returns></returns>
        public static async Task EndAuctionOrder(
            Wallet sender,
            string tokenId,
            string bidPrice,
            string tokenAddress,
        ...
        public static async Task WithdrawFunds(
            Wallet sender,
            string MarketplaceAddress,
            string gasLimit,
            Action onComplete = null)
